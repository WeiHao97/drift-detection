...
cityscapes_dir = os.environ["FINE_ANN"]
img_dir = os.environ["IMG_DIR"] #"../cityscape_images/leftImg8bit"
...
def eval(model, device):
	...
	for object_category in label_dict:
		...
		for _set in sets:
			...
			for sub_folder in os.listdir(set_path):
				...
				for file in os.listdir(sub_path):
					...
					data["file_path"] = os.path.join(curr_img_path, file.replace("_gtFine_polygons.json", "_leftImg8bit.png"))
		...
		dataset = cityscapes_dataset(_json_lst)
